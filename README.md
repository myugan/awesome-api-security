...
| Author | Name | Description |
| ------ | ---- | ----------- |
| Practical DevSecOps | [Certified API Security Professional]([https://university.apisec.ai](https://www.practical-devsecops.com/certified-api-security-professional/) | World class DevSecOps Training and Certifications |
